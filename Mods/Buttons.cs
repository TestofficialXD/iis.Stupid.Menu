    ...
    public class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            ...
            new ButtonInfo[] { // Menu Settings [2]
                ...
                new ButtonInfo { buttonText = "Change Notification Sound", overlapText = "Change Notification Sound <color=grey>[</color><color=green>None</color><color=grey>]</color>", method =() => Settings.ChangeNotificationSound(), enableMethod =() => Settings.ChangeNotificationSound(), disableMethod =() => Settings.ChangeNotificationSound(false), incremental = true, isTogglable = false, toolTip = "Changes the sound that plays when receiving a notification."},
                ...
                new ButtonInfo { buttonText = "Change Button Sound", overlapText = "Change Button Sound <color=grey>[</color><color=green>Wood</color><color=grey>]</color>", method =() => Settings.ChangeButtonSound(), enableMethod =() => Settings.ChangeButtonSound(), disableMethod =() => Settings.ChangeButtonSound(false), incremental = true, isTogglable = false, toolTip = "Changes the button click sound."},
                new ButtonInfo { buttonText = "Change Button Volume", overlapText = "Change Button Volume <color=grey>[</color><color=green>4</color><color=grey>]</color>", method =() => Settings.ChangeButtonVolume(), enableMethod =() => Settings.ChangeButtonVolume(), disableMethod =() => Settings.ChangeButtonVolume(false), incremental = true, isTogglable = false, toolTip = "Changes the volume of the buttons."},
            ...
            new ButtonInfo[] { // Room Mods [6]
                ...
                new ButtonInfo { buttonText = "Auto Join Room \"PBBV\"", method =() => rejRoom = "PBBV", isTogglable = false, toolTip = "Automatically attempts to connect to room \"PBBV\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"BOT\"", method =() => rejRoom = "BOT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"BOT\" every couple of seconds until connected." },
                ...
                new ButtonInfo { buttonText = "Auto Join Room \"JMANCURLY\"", method =() => rejRoom = "JMANCURLY", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JMANCURLY\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"JMAN\"", method =() => rejRoom = "JMAN", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JMAN\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"ELLIOT\"", method =() => rejRoom = "ELLIOT", isTogglable = false, toolTip = "Automatically attempts to connect to room \"ELLIOT\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"TYLERVR\"", method =() => rejRoom = "TYLERVR", isTogglable = false, toolTip = "Automatically attempts to connect to room \"TYLERVR\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"JUANGTAG\"", method =() => rejRoom = "JUANGTAG", isTogglable = false, toolTip = "Automatically attempts to connect to room \"JUANGTAG\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"GHOST\"", method =() => rejRoom = "GHOST", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GHOST\" every couple of seconds until connected." },
                new ButtonInfo { buttonText = "Auto Join Room \"GULLIBLE\"", method =() => rejRoom = "GULLIBLE", isTogglable = false, toolTip = "Automatically attempts to connect to room \"GULLIBLE\" every couple of seconds until connected." },
            },
            ...
            new ButtonInfo[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Orbit Bat", method =() => Fun.OrbitObject("Cave Bat Holdable", 120f), toolTip = "Orbits the bat around you." },
                ...
                new ButtonInfo { buttonText = "Destroy Bug", method =() => Fun.DestroyObject("Floating Bug Holdable"), isTogglable = false, toolTip = "Sends the bug to hell." },
                new ButtonInfo { buttonText = "Destroy Bat", method =() => Fun.DestroyObject("Cave Bat Holdable"), isTogglable = false, toolTip = "Sends the bat to hell." },
            ...
            new ButtonInfo[] { // Overpowered Mods [17]
                ...
                new ButtonInfo { buttonText = "Grab All <color=grey>[</color><color=green>G</color><color=grey>]</color>", method =() => Overpowered.GrabAll(), toolTip = "Grabs everyone in the room if you're the guardian."},
                ...
                new ButtonInfo { buttonText = "Release All <color=grey>[</color><color=green>T</color><color=grey>]</color>", method =() => Overpowered.ReleaseAll(), toolTip = "Releases everyone in the room if you're the guardian."},

                new ButtonInfo { buttonText = "Fling Gun", method =() => Overpowered.FlingGun(), toolTip = "Flings whoever your hand desires."},
                new ButtonInfo { buttonText = "Fling All <color=grey>[</color><color=green>T</color><color=grey>]</color>", method =() => Overpowered.FlingAll(), toolTip = "Flings everyone in the room."},

                new ButtonInfo { buttonText = "Bring Gun", method =() => Overpowered.BringGun(), toolTip = "Brings whoever your hand desires towards you."},
                new ButtonInfo { buttonText = "Bring All <color=grey>[</color><color=green>T</color><color=grey>]</color>", method =() => Overpowered.BringAll(), toolTip = "Brings everyone in the room towards you."},

                new ButtonInfo { buttonText = "Bring All Gun", method =() => Overpowered.BringAllGun(), toolTip = "Brings everyone in the room towards wherever your hand desires."},
                ...
                new ButtonInfo { buttonText = "Physical Freeze All <color=grey>[</color><color=green>T</color><color=grey>]</color>", method =() => Overpowered.PhysicalFreezeAll(), toolTip = "Freezes everyone in the room when holding <color=green>trigger</color>." },
